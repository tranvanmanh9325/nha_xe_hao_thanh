...
const ConfirmDeleteModal = ({ isOpen, onClose, onConfirm, trip }) => {
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all">
        <div className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-bold text-slate-900 mb-2">Xác nhận xóa chuyến xe</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
                Bạn có chắc chắn muốn xóa chuyến xe <span className="font-semibold text-slate-800">{trip.route}</span> khởi hành lúc <span className="font-semibold text-slate-800">{formattedTime}</span>?
              </p>
              <p className="text-sm text-slate-600 leading-relaxed mt-1">
                Chỉ cho phép xóa nếu chưa có vé nào được đặt. Hành động này không thể hoàn tác.
              </p>
            </div>
          </div>
        </div>
