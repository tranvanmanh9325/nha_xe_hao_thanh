...
/* ---- Plus — add new item ---- */
export const PlusIcon = ({ size = 22, className = '' }) => (
  <svg {...baseProps(size, className)}>
...
/* ---- Edit — pencil icon ---- */
export const EditIcon = ({ size = 22, className = '' }) => (
  <svg {...baseProps(size, className)}>
...
/* ---- Trash — delete bin ---- */
export const TrashIcon = ({ size = 22, className = '' }) => (
  <svg {...baseProps(size, className)}>
...
/* ---- Filter — funnel ---- */
export const FilterIcon = ({ size = 22, className = '' }) => (
  <svg {...baseProps(size, className)}>
...
export const ChevronRightIcon = ({ size = 22, className = '' }) => (
  <svg {...baseProps(size, className)}>
...
/* ---- Eye — view details ---- */
export const EyeIcon = ({ size = 22, className = '' }) => (
  <svg {...baseProps(size, className)}>
...
/* ---- Message — chat bubble ---- */
export const MessageIcon = ({ size = 22, className = '' }) => (
  <svg {...baseProps(size, className)}>
